...
//clamp 1
  ...
  chassis.pid_wait();
  chassis.pid_odom_set({{62.5, -60.5}, rev, 85});
  chassis.pid_wait();
  clamps.set(true);
  setIntake(0);
  //END OF CORNER 1 
...
// CLAMP 2 
  chassis.pid_odom_set({{6, -52}, fwd, 115});
  chassis.pid_wait();
  chassis.pid_turn_set(-90, 100);
  chassis.pid_wait();
  chassis.pid_odom_set({{-24.8,-52},rev, 85});
  chassis.pid_wait();
  clamps.set(false);
  setIntake(-127);
...
/*  liftPID.target_set(268);
  ...
  chassis.pid_wait();
  chassis.pid_odom_set({{-58, -66}, rev, 110});
  chassis.pid_wait();
  clamps.set(true);
  setIntake(0);
// END OF CORNER 2 
  ...
  setIntake(0);
  chassis.pid_wait();
  chassis.pid_odom_set({{-60, 66}, fwd, 127});
  setroller(127);
  pros::delay(2800);
  chassis.pid_odom_set({{0, 47, -90}, rev, 127});
  chassis.pid_wait();
  clamps.set(false);
  pros::delay(150);
  setroller(0);
