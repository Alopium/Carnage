...
liftPID.target_set(0);
setIntake(-127);
chassis.pid_odom_set({{-21, -22, -146},rev, 115});
chassis.pid_wait();
pros::delay(100);
clamps.set(false);
pros::delay(150);
...
liftPID.target_set(0);
setIntake(-127);
chassis.pid_odom_set({{-49, -5.5, 0}, fwd, 120});
pros::delay(2000);
doinkr.set(true);
pros::delay(500);
setIntake(0);
...
chassis.pid_drive_set(-38, 127);
chassis.pid_wait();
chassis.pid_odom_set({{22.5, -22.5, 150}, rev, 110});
pros::delay(600);
doinklc.set(false);
pros::delay(500);
doinkl.set(false);
...
//alliance stake 
  ...
  setIntake(-127);
  pros::delay(700);
  chassis.pid_odom_set({{0, -52}, fwd, 120});
  //chassis.pid_drive_set(11.45 ,110);
  chassis.pid_wait();
//clamp 1
  chassis.pid_odom_set({{24.8,-52, 90},rev, 85});
  chassis.pid_wait();
  clamps.set(false);
  ...
  chassis.pid_wait();
  chassis.pid_odom_set({{48,-1.5}, rev, 127});
  chassis.pid_wait();
  chassis.pid_turn_set(180, 110);
  chassis.pid_wait();
  /*liftPID.target_set(282);
  pros::delay(100);
  chassis.pid_turn_set(89, 110);
  chassis.pid_wait();
  //chassis.pid_drive_set(12, 50);
  chassis.pid_odom_set({{62, -0.70}, fwd, 34});
  chassis.pid_wait();
  pros::delay(600);
  //loadlb();
  setIntake(0);
  ...
  chassis.pid_odom_set({{50.5, -24}, fwd, 127});
  chassis.pid_wait();
  chassis.pid_odom_set({{50.5, -58}, fwd, 80});
  chassis.pid_wait();
  chassis.pid_drive_set(6, 70);
  chassis.pid_wait();
  pros::delay(300);
  chassis.pid_odom_set({{42, -52}, rev, 118});
  chassis.pid_wait();
  unjam();
  pros::delay(200);
  setIntake(-127);
  chassis.pid_odom_set({{61, -49}, fwd, 118});
  chassis.pid_wait();
  chassis.pid_drive_set(-6, 110);
  chassis.pid_wait();
  chassis.pid_turn_set(-30, 115);
  chassis.pid_wait();
  chassis.pid_odom_set({{62.5, -62}, rev, 85});
  chassis.pid_wait();
  pros::delay(200);
  clamps.set(true);
  unjam();
...
/*  liftPID.target_set(268);
  ...
  pros::delay(600);
  setIntake(-127);
  chassis.pid_drive_set(-12,115);
  chassis.pid_wait();
  liftPID.target_set(0);*/
  chassis.pid_odom_set({{-42, -24}, fwd, 115});
  chassis.pid_wait();
  chassis.pid_odom_set({{-42, -60}, fwd, 75});
  chassis.pid_wait();
  ...
  pros::delay(200);
  setIntake(-127);
  chassis.pid_odom_set({{-55, -54}, fwd, 110});
  chassis.pid_wait();
  pros::delay(400);
  chassis.pid_drive_set(-6, 110);
  chassis.pid_wait();
...
// END OF CORNER 2 
  ...
  setIntake(0);
  pros::delay(2800);
  chassis.pid_odom_set({{5, 46.5, -90}, rev, 127});
  chassis.pid_wait();
  clamps.set(false);
  pros::delay(150);
  setroller(0);
  setIntake(-127);
  chassis.pid_odom_set({{60, 52}, fwd, 127});
  chassis.pid_wait();
  pros::delay(200);
  ...
  chassis.pid_wait();
  clamps.set(true);
  chassis.pid_odom_set({{48,48}, fwd, 127});
